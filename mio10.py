...
if __name__=='__main__':
    ...
    headers = { 'Content-Type': 'application/json'} #puede contener varios headers (varios elementos del diccionario)
...
# Si observamos el contenido de la respuesta, vemos los valores enviados en headers. 